...
df = data.drop(columns=['likely_values'])

# Separate features and target
x = df.drop(columns=['is_sensitive'])
y = df['is_sensitive']

# Define categorical and numerical features
categorical_features = ['feature_name', 'data_type', 'has_names', 'semantic_keywords']
numeric_features = ['unique_ratio']
